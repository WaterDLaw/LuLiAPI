...
class CreateMesswerte extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('messwertes', function (Blueprint $table) {
            ...
            $table->decimal('fev1soll_vor',12,8)->nullable();
            $table->decimal('fev1soll_nach',12,8)->nullable();

            $table->decimal('fvc_vor',5,2)->nullable();
            $table->decimal('fvc_nach',5,2)->nullable();

            $table->decimal('fev1_fvc_vor',12,8)->nullable();
            $table->decimal('fev1_fvc_nach',12,8)->nullable();
            ...
            $table->decimal('rv_tlc_vor',12,8)->nullable();
            $table->decimal('rv_tlc_nach',12,8)->nullable();
            ...
            $table->decimal('saO2_vor',12,8)->nullable();
            $table->decimal('saO2_nach',12,8)->nullable();
            ...
            $table->decimal('max_leistungS_vor',12,8)->nullable();
            $table->decimal('max_leistungS_nach',12,8)->nullable();
            ...
            $table->decimal('distanzS_vor',12,8)->nullable();
            $table->decimal('distanzS_nach',12,8)->nullable();

            
            $table->decimal('saO2min_vor',12,8)->nullable();
            $table->decimal('saO2min_nach',12,8)->nullable();
